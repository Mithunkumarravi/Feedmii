...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            CGFloat spacing =0.85 *[self valueForOption:iCarouselOptionSpacing withDefault:1.0f];
            CGFloat arc = 0.35 * [self valueForOption:iCarouselOptionArc withDefault:M_PI * 2.0f];
